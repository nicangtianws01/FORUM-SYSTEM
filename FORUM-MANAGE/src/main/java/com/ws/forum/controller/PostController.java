...
public class PostController {
	...
	@GetMapping("/doGetPageObject/{pageCurrent}")
	public JsonResult doFindPageObjects(String keyword,@PathVariable Integer pageCurrent) {
	...
	public JsonResult doSaveObject(Post entity) {
		...
		return JsonResult.successMsg("添加成功！"+entity.getTitle() + "--"+entity.getContent()+ "--" +entity.getTypeId());
	}
